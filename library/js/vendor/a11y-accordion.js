 ...
 * Usablewp Modifications 1: 562 - element.removeClass('open');
 * Usablewp Modifications 2: 612 - element.addClass('open');
 * --------------------------------------------------------------------
 */
...
(function($){
  /* ------------------------------------------------------------------*/
	...
	var myAccordion = new A11yAccordion({
	  parentSelector: '.a11yAccordion',
	  showSearch: false,
	  showOne: true,
	  overallSearch: false,
	});
  var openNumber = parseInt($(".naive-accordion").data('open'), 10) - 1;
	myAccordion.uncollapseRow(0);
})(jQuery);
