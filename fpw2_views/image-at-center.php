<?php
/**
 * Custom "Image at center" template file for "Feature a page widget" plugin
 *
...
<article class="fpw-image-at-center fpw-container">
	<div class="fpw-featured-image">
		<a href="<?php the_permalink(); ?>">
				<?php $full = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), 'sqaure' ); ?>
