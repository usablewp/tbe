<?php
/**
 * Template Name: Custom Modern
 * Description: A custom design comes only with "The Basis of Theme" theme. Uses screen-reader friendly markup.
 */
?>
<?php do_action( 'wpmtst_before_view' ); ?>

<div class="strong-view custom-modern <?php wpmtst_container_class(); ?>"<?php wpmtst_container_data(); ?>>
				...
				<div class="testimonial-inner">
					...
					<div class="testimonial-content">
						...
						<blockquote>
							...
							<footer>
									<div class="author-image"><?php wpmtst_the_thumbnail(); ?></div>
					        <div class="author"><?php wpmtst_the_client(); ?></div>
					    </footer>
						</blockquote>
					</div>
